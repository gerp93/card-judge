DROP PROCEDURE IF EXISTS SP_DISCARD_CARD;

CREATE PROCEDURE SP_DISCARD_CARD(IN VAR_PLAYER_ID CHAR(36), IN VAR_CARD_ID CHAR(36))
BEGIN
    DECLARE VAR_LOBBY_ID CHAR(36);
    DECLARE VAR_PLAYER_USER_ID CHAR(36);
