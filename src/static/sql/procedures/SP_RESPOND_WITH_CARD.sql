DROP PROCEDURE IF EXISTS SP_RESPOND_WITH_CARD;

CREATE PROCEDURE SP_RESPOND_WITH_CARD(
    IN VAR_PLAYER_ID CHAR(36),
    IN VAR_CARD_ID CHAR(36),
    IN VAR_SPECIAL_CATEGORY ENUM('SURPRISE', 'STEAL', 'FIND', 'WILD')
)
BEGIN
    DECLARE VAR_RESPONSE_CARD_ID CHAR(36) DEFAULT (UUID());
    ...
    DECLARE VAR_RESPONSE_ID CHAR(36) DEFAULT (
            SELECT
                ID
            FROM (
                    SELECT
