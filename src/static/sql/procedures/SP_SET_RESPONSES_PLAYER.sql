DROP PROCEDURE IF EXISTS SP_SET_RESPONSES_PLAYER;

CREATE PROCEDURE SP_SET_RESPONSES_PLAYER(IN VAR_PLAYER_ID CHAR(36))
BEGIN
    ...
    DECLARE VAR_RESPONSE_ID_TO_REMOVE CHAR(36);
